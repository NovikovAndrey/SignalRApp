...
describe('AppComponent', () => {
  ...
  it(`should have as title 'angular-signalRNew'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.debugElement.componentInstance;
    expect(app.title).toEqual('angular-signalRNew');
  });
  ...
  it('should render title in a h1 tag', () => {
    ...
    expect(compiled.querySelector('h1').textContent).toContain('Welcome to angular-signalRNew!');
  });
